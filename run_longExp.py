...
parser.add_argument('--enc_in', type=int, default=34, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
...
if __name__ == '__main__':
    ii = 0  # 这里的 ii 暂时设置为 0，你可以根据需要进行修改
